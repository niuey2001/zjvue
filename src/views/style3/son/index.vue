<template>
  <div class="main-boxdiv">  
    ...
    <el-form ref="adduser" :model="adduser" :rules="rules" label-width="0px" class="custom-form-style" v-loading="loadingadd">
        ...
        <tr>
          ...
          <td class="el-form-table-tr">        
            <el-form-item label="" required>
              <el-checkbox style="width: 100%;height: 20px;" :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
              <el-checkbox-group  v-model="authority" @change="handleCheckedCitiesChange">
                <el-checkbox v-for="items in authoritydata" :label="items.value" :key="items.name" :value="items.value" >{{items.name}}</el-checkbox>
              </el-checkbox-group>                                                               
            </el-form-item> 
        </td>
        </tr>   
    ...
    <el-form ref="edit" :model="editdata" :rules="editrules" label-width="0px" class="custom-form-style" v-loading="loadingadd">
      <table border="1" class="el-form-table">
        <tr>
          <td class="el-form-table-label">账号</td>
          <td>        
        ...
        <tr>
          ...
          <td class="el-form-table-tr">        
            <el-form-item label="" required>
              <el-checkbox style="width: 100%;height: 20px;" :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
              <el-checkbox-group  v-model="authority" @change="handleCheckedCitiesChange">
                <el-checkbox v-for="items in authoritydata" :label="items.value" :value="items.value" :key="items.name">{{items.name}}</el-checkbox>
              </el-checkbox-group>                                                               
            </el-form-item> 
        </td>
        </tr>  
    ...
    <el-dialog v-model="dialogFormVisible3" title="" class="dssetCom-dialog"> 
      ...
      <div class="main-boxdiv1" style="width: 100%;height:92%;">
        <el-table border  :header-cell-class-name="'trheader'" :data="logdata.logtable" height="100%" style="width: 100%">
