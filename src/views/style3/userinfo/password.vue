<template>
  <div class="main-boxdiv" style="width: 800px;padding-top:3px;">  
    ...
    <el-form ref="modifyForm" :model="modifyForm" :rules="rules" label-width="0px" class="custom-form-style" style="width:100%">
              ...
              <tr>
                ...
                <td>        
                  <el-form-item label="" prop="OldPassword">
                    <el-input type="password" style="width:120px;" v-model="modifyForm.OldPassword" placeholder="请输入旧密码"></el-input>
                  </el-form-item> 
                </td>
              </tr>
              <tr>
                ...
                <td>        
                  <el-form-item label="" prop="NewPassword">
                    <el-input type="password" style="width:120px;" v-model="modifyForm.NewPassword" placeholder="请输入新密码"></el-input>
                  </el-form-item> 
                </td>
              </tr>
              <tr>
                ...
                <td>        
                  <el-form-item label="" prop="ConfirmPassword">
                    <el-input type="password" style="width:120px;" v-model="modifyForm.ConfirmPassword" placeholder="请再次输入密码"></el-input>
                  </el-form-item> 
                </td>
              </tr>                            
              <tr>
